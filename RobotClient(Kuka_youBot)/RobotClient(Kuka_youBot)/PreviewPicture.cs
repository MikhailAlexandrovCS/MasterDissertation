...
{
    public partial class PreviewPicture : Form
    {
        public PreviewPicture(List<Point3D> pointCloud, Point3D startPoint, Point3D endPoint, int xBorder, int yBorder, int safeDistance, PreviewObjectType previewObjectType)
        {
            InitializeComponent();
        ...
        private void glControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                sphere(_safeDistance, 100, 100, (int)_endPoint.X, (int)_endPoint.Y, (int)_endPoint.Z, PointType.EndPoint);
                sphere(_safeDistance, 100, 100, (int)_startPoint.X, (int)_startPoint.Y, (int)_startPoint.Z, PointType.StartPoint);
            }
            else
            {
                sphere(10, 100, 100, (int)_endPoint.X, (int)_endPoint.Y, (int)_endPoint.Z, PointType.EndPoint);
                sphere(10, 100, 100, (int)_startPoint.X, (int)_startPoint.Y, (int)_startPoint.Z, PointType.StartPoint);
            }
        ...
        private void PreviewPicture_Load(object sender, EventArgs e)
        {
            pictureBox1.Size = new Size(glControl1.Size.Width + _xBorder + 10, _yBorder + 10);
            this.Size = new Size((_xBorder + 10) * 2, _yBorder + 10);
        }

        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            for(int i = 0; i < _pointCloud.Count; i++)
                e.Graphics.FillEllipse(Brushes.Black, (float)_pointCloud[i].X, (float)_pointCloud[i].Y, 2, 2);
